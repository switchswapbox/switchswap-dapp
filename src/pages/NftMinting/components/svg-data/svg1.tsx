  ...
  return (
    ...
    >
      <foreignObject x="0" y="0" width="725" height="438">
        <img src="\static\mock-images\bg_svgs\bg_svg1.png" alt="backgound" />
      </foreignObject>
      ...
      <foreignObject x="450" y="85" width={651} height={192} transform="scale(0.3)">
        <img src="\static\mock-images\bg_svgs\crust-long-black.png" alt="logo1" />
      </foreignObject>

      <foreignObject x="1250" y="90" width={768} height={169} transform="scale(0.3)">
        <img src="\static\mock-images\bg_svgs\polygon-long-black.png" alt="logo1" />
      </foreignObject>
    </svg>
  );
}
